...
class Database:
    ...
    def __init__(self, id_="", manager=None):
        """
...
class DatabaseUser:
    ...
    def __init__(self, id_="", passwd="", manager=None):
        """
...
def get(id_=None, type_=None):
    ...
    :param str id_: If present, obtain one database that matches this ID
...
def get_user(id_=None, type_=None):
    """
